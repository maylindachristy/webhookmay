...
func PostBalasan(w http.ResponseWriter, r *http.Request) {
	...
	link := "https://medium.com/@maylindachristy/tugas-gis-chapter-7-whatsauth-free-2fa-otp-notif-whatsapp-gateway-api-gratis-fddb2a2e5384"
	if r.Header.Get("Secret") == os.Getenv("SECRET") {
		if msg.Message == "loc" || msg.Message == "Loc" || msg.Message == "lokasi" || msg.LiveLoc {
			...
			dt := &wa.TextMessage{
				To:       msg.Phone_number,
				IsGroup:  false,
				Messages: "Hai Hai Haiii friend! " + msg.Alias_name + "\nSalam kenal yaa, aku Maylindaa \n Tapi maaf banget yaaa, Maylinda nya lagi sibuk. \n Cara penggunaan WhatsAuth ada di link berikut ini ya kak...\n" + link,
			}
			resp, _ = atapi.PostStructWithToken[atmessage.Response]("Token", os.Getenv("TOKEN"), dt, "https://api.wa.my.id/api/send/message/text")
		}
	} else {
